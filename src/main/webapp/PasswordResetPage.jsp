                      ...
                      ${msg}
                       <span style="color:red">
                         ...
                         <div class="form-group mb-3">
                             ...
                             <input type="email" class="form-control" id="email" name="email"  ${action == 'retain' ? 'readonly' : ' '} value="${key.email}"  placeholder="Enter email">
                          ...
                          <div class="form-group mb-3">
                           ...
                           <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="newpassword" value="${dto.newpassword}" name="newpassword" placeholder="Enter password">
                            <small class="error" id="passwordError"></small>
                            </div>
                             <div class="form-group mb-3">
