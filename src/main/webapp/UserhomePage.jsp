...
<body>
    <nav class="navbar navbar-light bg-dark">
        <div class="container" style="display: flex; flex-direction: row;">
            ...
            <div>
                        <a class="navbar-brand" href="RiseComplaint.jsp" style="color: aliceblue;">RiseComplaint</a>
                           </div>
                        <a class="navbar-brand" href="ViewComplaint.jsp" style="color: aliceblue;">view complaint</a>
