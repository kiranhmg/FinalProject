    ...
    <nav class="navbar navbar-light bg-dark">
     ...
     <div class="container mt-5">
             <div class="card style=width: 18rem;">
                 ...
                 <div class="card-body">
                     <form action="addemployee" method="post" id="signUpForm">
                         ...
                         <div class="form-group">
                                 ...
                                 <div class="form-group mb-3">
                                  ...
                                  <div class="form-group mb-3">
                                                              ...
                                                              <input type="text" class="form-control" id="designation" name="designation"  placeholder="Enter first name"  onblur="validateFirstName()">
                                                              <small class="error" id="firstNameError"></small>
                                                          </div>
